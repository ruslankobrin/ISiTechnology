...
urlpatterns = [
    ...
    path(
        "threads_by_user/<int:user_id>/",
        ThreadListAPIView.as_view(),
        name="threads_by_user",
    ),
    path(
        "threads/<int:pk>/",
        ThreadRetrieveDeleteView.as_view(),
        name="thread_retrieve_delete",
    ),
    ...
    path(
        "messages_by_thread/<int:thread_id>/",
        MessageListByThreadAPIView.as_view(),
        name="messages_by_thread",
    ),
    path(
